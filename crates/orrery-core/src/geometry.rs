...
//!
//! This module provides fundamental geometric types used throughout Orrery
...
//! # Coordinate System
//!
//! Orrery uses a coordinate system consistent with SVG:
//!
//! ```text
//!   (0,0) ────────► +X
//!     │
...
impl Bounds {
    ...
    ///
    /// ```
    /// # use orrery_core::geometry::{Bounds, Point, Size};
