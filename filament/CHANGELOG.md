...
All notable changes to the Filament project will be documented in this file.
...
- **Filament DSL** — Text-based domain-specific language for describing diagrams.
...
- **CLI** — `filament` command-line tool for rendering `.fil` files to SVG with configurable output, logging, and TOML-based configuration.
- **Configuration** — Layered configuration via CLI flags, project-local files, and platform-specific config directories.
- **Dual licensing** — MIT OR Apache-2.0.

[Unreleased]: https://github.com/foadnh/filament/compare/4b825dc642cb6eb9a060e54bf8d69288fbee49040...HEAD
